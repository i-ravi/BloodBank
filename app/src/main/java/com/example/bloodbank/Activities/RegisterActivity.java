...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void message(){
        ...
        if (permissionCheck== PackageManager.PERMISSION_GRANTED){
            ...
            smsManager.sendTextMessage("8967452355",null,"Thank you for registering with the Blood Bank. Your Blood will help millions to live a long life.",null,null);
        ...
        switch (requestCode){
            case 0:{
                if (grantResults.length>=0 && grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    SmsManager smsManager=SmsManager.getDefault();
                    smsManager.sendTextMessage("896745235",null,"Thank you for registering with the Blood Bank. Your Blood will help millions to live a long life.",null,null);
